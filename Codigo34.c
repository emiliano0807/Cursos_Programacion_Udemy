/* Visualizacion la tarifa de la luz segun el gasto de corriente electrica.
Para un gasto menor de 1.000Kwxh la tarifa es 1.2, entre 1.OOO y 1.850Kwxh es 1.0 y mayor
de 1.85OKwxh 0.9.*/
